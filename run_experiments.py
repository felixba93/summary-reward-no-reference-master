...
#    device = 'gpu'
    ...
    for learn_rate,model_type,seed in itertools.product(learn_rates,model_types,seeds):
        ...
        args=['dummy','--epoch_num', epoch_num, '--batch_size', batch_size, '--train_percent',  train_percent,  '--dev_percent', dev_percent, '--learn_rate', learn_rate, '--model_type', model_type, '--device', device, '--seed', seed, '--file_name', file_name]
